...
const DataTableToolbar = <TData,>({
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      {isFilterApplied ? (
        <Button variant="ghost" onClick={onResetFilters} className="h-8 px-2 lg:px-3 me-1">
          Reset <X className="ml-2 h-4 w-4" />
        </Button>
      ) : (
        <Button variant="outline" onClick={onOpenFilter} className="h-8 px-2 lg:px-3 me-1">
